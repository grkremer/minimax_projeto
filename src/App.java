...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Simulador s = new Simulador(new Alquerque(), new MCTS_RAVE(Jogo.PECA_BRANCA, 5000), new MCTS(1, Jogo.PECA_PRETA, 5000, 1, false, false));

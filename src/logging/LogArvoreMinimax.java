...
public class LogArvoreMinimax {
    ...
    private void ProcessarArvore(NodoMinimax nodo, int profundidade)
    {
        ...
        graphBuilder.addNode(nodo.getCopiaEstado(), Float.toString(nodo.getRecompensa()));
        ...
        //pega os filhos
        for (NodoMinimax filho : nodo.getFilhos().values()) {
            graphBuilder.addEdge(nodo.getCopiaEstado(), filho.getCopiaEstado());
